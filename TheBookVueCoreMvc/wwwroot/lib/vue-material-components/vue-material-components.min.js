...
var n={bind:function(){for(var e=this.vm,t=e.$Parts,n=e.$options._content,r=0;r<n.children.length;r++){var i=n.children[r].cloneNode(!0)
...
else{if(x.Hooks.registered[R]){var V=x.Hooks.getParts(R),A=a(j).PartsPropertyValueCache[V]
A&&(k.PartsPropertyValue=A)}var $=x.setPropertyValue(j,R,k.currentValue+(0===parseFloat(q)?"":k.unitType),k.PartsPropertyValue,k.scrollData)
x.Hooks.registered[R]&&(x.Normalizations.registered[V]?a(j).PartsPropertyValueCache[V]=x.Normalizations.registered[V]("extract",null,$[1]):a(j).PartsPropertyValueCache[V]=$[1]),"transform"===$[0]&&(S=!0)}}c.mobileHA&&a(j).transformCache.translate3d===r&&(a(j).transformCache.translate3d="(0px, 0px, 0px)",S=!0),S&&x.flushTransformCache(j)}}c.display!==r&&"none"!==c.display&&(b.State.calls[o][2].display=!1),c.visibility!==r&&"hidden"!==c.visibility&&(b.State.calls[o][2].visibility=!1),c.progress&&c.progress.call(l[1],l[1],g,Math.max(0,p+c.duration-t),p,y),1===g&&d(o)}}b.State.isTicking&&O(u)}function d(e,t){if(!b.State.calls[e])return!1
...
if(t||o.loop||("none"===o.display&&x.setPropertyValue(d,"display",o.display),"hidden"===o.visibility&&x.setPropertyValue(d,"visibility",o.visibility)),o.loop!==!0&&(f.queue(d)[1]===r||!/\.velocityQueueEntryFlag/i.test(f.queue(d)[1]))&&a(d)){a(d).isAnimating=!1,a(d).PartsPropertyValueCache={}
var p=!1
...
var g=400,m="swing",b={State:{isMobile:/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent),isAndroid:/Android/i.test(navigator.userAgent),isGingerbread:/Android 2\.3\.[3-7]/i.test(navigator.userAgent),isChrome:t.chrome,isFirefox:/Firefox/i.test(navigator.userAgent),prefixElement:n.createElement("div"),prefixMatches:{},scrollAnchor:null,scrollPropertyLeft:null,scrollPropertyTop:null,isTicking:!1,calls:[]},CSS:{},Utilities:f,Redirects:{},Easings:{},Promise:t.Promise,defaults:{queue:"",duration:g,easing:m,begin:r,complete:r,progress:r,display:r,visibility:r,loop:!1,delay:!1,mobileHA:!0,_cacheValues:!0},init:function(e){f.data(e,"velocity",{isSVG:h.isSVG(e),isAnimating:!1,computedStyle:null,tweensContainer:null,PartsPropertyValueCache:{},transformCache:{}})},hook:null,mock:!1,version:{major:1,minor:2,patch:2},debug:!1}
...
x.Hooks.registered[a]=[n,l]}}},getParts:function(e){var t=x.Hooks.registered[e]
return t?t[0]:e},cleanPartsPropertyValue:function(e,t){return x.RegEx.valueUnwrap.test(t)&&(t=t.match(x.RegEx.valueUnwrap)[1]),x.Values.isCSSNullValue(t)&&(t=x.Hooks.templates[e][1]),t},extractValue:function(e,t){var n=x.Hooks.registered[e]
if(n){var r=n[0],i=n[1]
return t=x.Hooks.cleanPartsPropertyValue(r,t),t.toString().match(x.RegEx.valueSplit)[i]}return t},injectValue:function(e,t,n){var r=x.Hooks.registered[e]
if(r){var i,o,a=r[0],l=r[1]
return n=x.Hooks.cleanPartsPropertyValue(a,n),i=n.toString().match(x.RegEx.valueSplit),i[l]=t,o=i.join(" ")}return n}},Normalizations:{registered:{clip:function(e,t,n){switch(e){case"name":return"clip"
case"extract":var r
...
if(x.Hooks.registered[n]){var c=n,u=x.Hooks.getParts(c)
...
else{if(x.Hooks.registered[n]){var s=n,c=x.Hooks.getParts(n)
...
if(V=e(y[T]),A=V[0],E=V[1],M=V[2],T=x.Names.camelCase(T),B=x.Hooks.getParts(T),L=!1,a(o).isSVG||"tween"===B||x.Names.prefixCheck(B)[1]!==!1||x.Normalizations.registered[B]!==r){if((l.display!==r&&null!==l.display&&"none"!==l.display||l.visibility!==r&&"hidden"!==l.visibility)&&/opacity|filter/.test(T)&&!M&&0!==A&&(M=0),l._cacheValues&&C&&C[T]?(M===r&&(M=C[T].endValue+C[T].unitType),L=a(o).PartsPropertyValueCache[B]):x.Hooks.registered[T]?M===r?(L=x.getPropertyValue(o,B),M=x.getPropertyValue(o,T,L)):L=x.Hooks.templates[B][1]:M===r&&(M=x.getPropertyValue(o,T)),F=!1,z=u(T,M),M=z[0],N=z[1],z=u(T,A),A=z[0].replace(/^([+-\/*])=/,function(e,t){return F=t,""}),I=z[1],M=parseFloat(M)||0,A=parseFloat(A)||0,"%"===I&&(/^(fontSize|lineHeight)$/.test(T)?(A/=100,I="em"):/^scale/.test(T)?(A/=100,I=""):/(Red|Green|Blue)$/i.test(T)&&(A=A/100*255,I="")),/[\/*]/.test(F))I=N
...
case"*":A=M*A
break
case"/":A=M/A}s[T]={PartsPropertyValue:L,startValue:M,currentValue:M,endValue:A,unitType:I,easing:E},b.debug&&console.log("tweensContainer ("+T+"): "+JSON.stringify(s[T]),o)}else b.debug&&console.log("Skipping ["+B+"] due to a lack of browser support.")}s.element=o}()}s.element&&(x.Values.addClass(o,"velocity-animating"),W.push(s),""===l.queue&&(a(o).tweensContainer=s,a(o).opts=l),a(o).isAnimating=!0,O===P-1?(b.State.calls.push([W,v,l,null,R.resolver]),b.State.isTicking===!1&&(b.State.isTicking=!0,u())):O++)}var i,o=this,l=f.extend({},b.defaults,m),s={}
